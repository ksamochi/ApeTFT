...
#define DMA_BUF_LINE (200U)   /* DMA transportation chunk size */
...
void setup() {
  ...
  (void)lv_timer_create(my_periodic_task, 10, NULL);
  xTaskCreatePinnedToCore(my_lvgl_task, "lvgl", 8192, NULL, 2, NULL, 1);
...
/* ----------------------------------------------------------- my_periodic_task */
static void my_periodic_task(lv_timer_t * timer)
{
  myApplMain_10ms();
}
